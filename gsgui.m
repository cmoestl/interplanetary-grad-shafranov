function varargout = gsgui(varargin)
...
% Edit the above text to modify the response to help gsgui
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @gsgui_OpeningFcn, ...
                   'gui_OutputFcn',  @gsgui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gsgui is made visible.
function gsgui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gsgui (see VARARGIN)

%path('C:\chris\Matlab\GS-code',path)
%cd('C:\chris\Matlab\GS-code')
currentdir=pwd

% Choose default command line output for gsgui
...
str=fscanf(fpar, '%c', 45); % str= Dateinamen der Daten, z.B.:..\data\winall291_95.mat
while feof(fpar) ~= 1
...
% UIWAIT makes gsgui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gsgui_OutputFcn(hObject, eventdata, handles) 
...
outstring=strvcat(out5, out1,out2,out3,out4, out6);
...
out5=['Jz (Amps):  ',num2str(current,'%4.2e')];
out6=['Axíal flux (Wb):  ',  num2str(flux, '%4.4e')];
outstring=strvcat(out0,out1,out2,out3,out4, out5, out6);
set(handles.text6,'String', outstring);
cd ..
...
if fileex == 2
   copyfile('ALLCASE.par',currentdir)
...
% --------------------------------------------------------------------
function newhelios_Callback(hObject, eventdata, handles)
% hObject    handle to newhelios (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
